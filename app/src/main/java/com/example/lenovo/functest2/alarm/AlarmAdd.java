...
import com.example.lenovo.functest2.FriendMainTabFragment;
import com.example.lenovo.functest2.MainActivity;
...
//            tv_date.setText(note.getDate());
    ...
    public void onBackPressed() {
        Intent intent = new Intent(AlarmAdd.this, FriendMainTabFragment.class);
